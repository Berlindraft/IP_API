    ...
    private function defineRoutes() {
        $this->routes = [
            'GET' => [
                ...
                'students/{id}' => [StudentController::class, 'getStudent'],
                'students/final-grades' => [StudentController::class, 'getAllFinalGrades'],
                'students/{id}/final-grade' => [StudentController::class, 'getFinalGradeById'],
            ],
            'POST' => [
